...
const info = [
  ...
  },
  {
    icon: <FaMapMarkedAlt />,
    title: "Address",
    description: "Pakistan , Rawalpindi ",
  },
];
          ...
          <div className="xl:w-[70%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl ">
              ...
              <p className="text-white/60">
                ...
                Distinctio accusantium fugiat aut deleniti. Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Incidunt, iste.
              </p>
              {/* input  */}
